...
bool TextureCube::Load (const char * right, const char * left, const char * top, const char * bottom, const char * front, const char * back)
{
...
bool TextureCube::Load (const char* (&arr)[6])
{
    ...
    for (unsigned char i = 0; i < 6; ++i) {
        ...
        GL_CALL (IL_CALL (glTexImage2D (GL_TEXTURE_CUBE_MAP_POSITIVE_X + i,
                                        0,
